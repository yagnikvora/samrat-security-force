  ...
  return (
    <section className={`relative left-1/2 right-1/2 -mx-[50vw] w-screen ${backgroundClassName}${sectionClassName}`}>
      <div className="mx-auto grid w-full max-w-[76rem] gap-10 px-5 py-12 sm:px-8 sm:py-14 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.9fr)] lg:items-center lg:gap-8 lg:ps-10 lg:pe-24 lg:py-18 xl:pe-40">
        ...
        <div className="relative mx-auto w-full max-w-[27rem] lg:mx-0 lg:ms-0 xl:max-w-[28.5rem]">
          <div className="relative aspect-[315/373] overflow-hidden rounded-[20px] border border-white/10 bg-secondary shadow-[0_20px_60px_rgba(0,0,0,0.45)]">
            <Image
          ...
          <div className="mt-4 space-y-3 md:absolute md:-left-[14rem] md:bottom-6 md:mt-0 md:w-[21rem]">
              ...
              >
                ...
                <div className="relative mt-3 h-2.5 overflow-hidden rounded-full bg-white/30">
                  ...
                  <div
                    ...
                    style={{ width: `${Math.max(0, 100 - item.value)}%` }}
                    aria-hidden
                  />
                </div>
              </article>
          ...
          <aside className="mt-4 rounded-2xl border border-white/20 bg-gradient-to-b from-[#17191f]/65 via-[#14161d]/58 to-[#0f1116]/52 p-5 shadow-[0_20px_45px_rgba(0,0,0,0.5)] backdrop-blur-xl lg:absolute lg:right-0 lg:top-1/2 lg:mt-0 lg:w-[18rem] lg:translate-x-[85%] lg:-translate-y-1/2">
