    ...
    <section className="page-container mt-20">
      <div className="glass-card rounded-3xl p-7 sm:p-10">
        <div className="grid gap-8 lg:grid-cols-[1fr_0.95fr] lg:items-center">
          ...
          <form className="rounded-2xl border border-white/10 bg-primary-35 p-4 sm:p-6">
            ...
            />
            <button type="button" className="mt-4 w-full rounded-full bg-brand px-5 py-3 text-sm font-semibold text-primary">
              Subscribe
            </button>
          </form>
        </div>
